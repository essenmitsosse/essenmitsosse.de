...
<html lang="en">
  <head>
    ...
    <title>How to achieve Likeness In A Portrait &clubs; essenmitsosse</title>

    <meta name="robots" content="index, follow" />
    <meta
      name="description"
      content="What is it that let’s a drawing look like the original face? Some thoughts on similarity."
    />
    <meta
      name="keywords"
      content="Analysis, caricature, drawing, guide, likeness, portrait, Theory, Tutorial"
    />
    <meta name="date" content="2008-04-08" />
    <meta name="author" content="Marcus Bl&auml;ttermann" />

    <link rel="prev" title="Linen Tunic" href="linen-tunic" />
    <link
      rel="next"
      title="How to set up Color Management"
      href="how-to-set-up-color-management"
    />
  ...
  <body class="single article">
    ...
    >
      ...
      <h1><em>How to achieve</em> Likeness In A Portrait</h1>
    </div>

    <div class="content white">
      <div class="date"><p>2008-04-08</p></div>
      <p>
        ...
        important? I did some experiments and found out some pretty interesting
        things.
      </p>
      <h2><em>It&#8217;s not about </em>the proportion</h2>
      <div class="sixwide">
        <p>
          Just look at the picture to the right. Can you recognize this person?
          I drew exactly over a photo of him, so the proportion should be quite
          correct.
        </p>
        <p>
      ...
      <h2>Creating Likeness <em>in a Portrait</em></h2>
      <div class="sixwide">
        <p>
        ...
        <p>
          But the light shows you something else. Something we didn&#8217;t saw
          in the first line-drawing. It shows you the 3-dimensional volume of
          the face.
        </p>
        <p>
          Everyone is able to identify someone from nearly every angle. Our
          brains seem to recognizes faces independently from the perspective in
          which we are seeing it. Our brains don&#8217;t remembers certain
      ...
      <h2><em>How to</em> line-draw a portrait</h2>
      <p>
      ...
      <p>
        ...
        find the big and the important shapes and forms and you have to find
        lines to describe them 2-dimensional.
      </p>
      <p>
        But don&#8217;t think 2-dimensional.
        <strong
          >Try to imagine how the lines are running into the room, try to push
          them into the space.</strong
        >
      </p>
      <p>
        ...
        probably just didn&#8217;t capture their subtle form and shape or gave
        no attention to their volume.
      </p>
      <p>
        That&#8217;s also why it&#8217;s so difficult to draw from a photo. You
        tend to draw just 2-dimensional shapes, ignoring the 3-dimensional form
        of the object. But you have to paint the volume.
      </p>
      <p>
        The more you are able to draw the volume instead of just flat shapes,
        the more you will notice, that your drawings will come to life, get more
      ...
      <hr />
      <h2><em>How to draw</em> a person from a photo</h2>
      <p>
        Don&#8217;t try to draw from just one photos. Try to get as much photo
        as possible of the person you are going to draw. The more references you
      ...
      <hr />
      <h2><em>A last hint for</em> caricatures</h2>
      <p>
