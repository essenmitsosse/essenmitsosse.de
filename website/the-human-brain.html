...
<html lang="en">
  <head>
    ...
    <title>The Human Brain &clubs; essenmitsosse</title>

    <meta name="robots" content="index, follow" />
    <meta
      name="description"
      content="Animated movie giving an idea about how the brain really works."
    />
    <meta
      name="keywords"
      content="8bit, animation, brain, human, intelligence, marcus blaettermann, neuron, pixel, student"
    />
    <meta name="date" content="2010-12-16" />
    <meta name="author" content="Marcus Bl&auml;ttermann" />

    <link rel="prev" title="kino.120a" href="kino-120a" />
    <link rel="next" title="Jack of all Trades" href="jack-of-all-trades" />
        ...
        <ul>
          <li class="newer">
            <a href="jack-of-all-trades" rel="next"
              ...
              <span class="title">Jack of all Trades</span></a
            >
          </li>
          <li class="older">
            <a href="kino-120a" rel="prev"
              ><span class="arrow">&#9658;</span>
              <span class="title">kino.120a</span></a
            >
          </li>
        </ul>
      </li>
    ...
    <div class="content white">
      ...
      <div class="fourwide">
        ...
        <p>
          ...
          which would be quite difficult, since there are still a lot of
          questions to be answered in this area of science. It is about giving
          an idea, that the brain is not made up of smaller brains, but of
          simple parts, which alone are not that intelligent. The whole is
