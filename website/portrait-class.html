...
<html lang="en">
  <head>
    ...
    <title>Portrait Class &clubs; essenmitsosse</title>

    <meta name="robots" content="index, follow" />
    <meta
      name="description"
      content="Paintings from a portrait class, made with Photoshop and a graphics tablet."
    />
    <meta
      name="keywords"
      content="colors, digital painting, images, life drawing, marcus blättermann, painting, portrait, student, study"
    />
