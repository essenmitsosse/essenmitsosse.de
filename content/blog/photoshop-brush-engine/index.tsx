    ...
    <body className="single article">
      ...
      <div className="content white">
        ...
        <p>
          ...
          starting from a brush tip shape that can be just a circle or a sampled
          image. This shape is repeated along the stroke. To avoid this looking
          boring, Photoshop gives you some tools to vary these shapes along the
          line to get a more complex look. Especially when working with a
          pressure sensitive stylus there are great ways to get a natural feel
          to your brushwork.
        </p>
        ...
        <div className="sixwide many">
          ...
          <p>
            The window that opens is the brushes palette. Here you will create
        ...
        <p>
          The brush engine of Photoshop is based on brush marks. These brush
          marks can have different shapes. They can just be circles or sampled
          monochrome images, where the black parts are the parts with the most
          opacity.
        </p>
        <p>
        ...
        <p>
          In the brushes palettes the first two menu-items, Brush Presets and
          Brush Tip Shape, just determines the basic shape of your brush marks.
        </p>
        <p>
          The others; Shape-Dynamics, Scattering, Texture, Dual Brush, Color
          Dynamics and Other Dynamics; offer you the tools to modify the way
        ...
        <div className="sixwide many">
          ...
          <ul>
            <li>
              <p>
                <strong>1.</strong> A jitter can randomly change a certain
                value, like the size of the brush, for every brush mark, that is
                drawn. To use a random jitter just slide up the scroll bar below
                it.
              </p>
            </li>
            <li>
              <p>
                ...
                fade or by pen pressure, pen tilt or the stylus wheel. To select
                one of these choose it from the drop-down menu Control.
              </p>
            </li>
          </ul>
          <p>
            If you choose a control, your graphics pad doesn&#8217;t support,
            there will be an exclamation point left of the drop-down menu
            warning you.
          </p>
          <ul>
            <li>
              <p>
                ...
                value it&#8217;s used for with every mark of the stroke you
                draw, until it reaches the minimum value. How many marks are
                drawn is determined by the number next to the drop-down menu.
              </p>
            </li>
            <li>
              <p>
                <strong>Pen Pressure</strong> is the classic setting and
                supported by most graphics tablet. It let the value it is used
                for depend on how much you impress your stylus.
              </p>
            </li>
            <li>
              <p>
                <strong>Pen Tilt</strong> is measuring the angle in which you
            ...
            <li>
              <p>
                ...
                value this jitter can create (for example the smallest brush
                size). The maximum of a jitter depends on the original value of
                the option that is jittered. If for example your opacity is set
                to 50% and the minimum opacity is set to 20%, an opacity jitter
                can only create brush marks with an opacity between these two
                values.
              </p>
            </li>
          </ul>
        ...
        <div className="sixwide many">
          <p>
            ...
            be a simple circle, a square or a more natural shape by using a
            sampled image.
          </p>
          <ul>
            <li>
              <p>
                <strong>The Diameter</strong> is just the basic size of your
                brush that can later be changed as always.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Hardness</strong> can only be used for the standard
                round or elliptic brush, not for sampled brushes. Decreasing the
                hardness will blur the edges of the circle, giving you a softer
                brush.
              </p>
            </li>
            <li>
              <p>
                <strong>Spacing</strong> is a good way to see how the brush
                engine of Photoshop works. Increase the spacing and the single
                brush marks will be drawn apart. The smaller the spacing, the
                more the brush marks will overlap each other. If you are just
                working with a round brush it is the best to decrease the
                spacing but when working with a textured brush this could
                probably cause a overlapping of the texture. If you are having
                performance issues you can also try to increase the spacing.
                Deactivating Spacing will make the space between the single
                brush marks depend on how fast you move the brush.
              </p>
            </li>
          </ul>
        </div>
          ...
          <li>
            <div className="sixwide many">
              <p>
                ...
                with pen pressure. It specifies how the size of brush marks vary
                in a stroke.
              </p>
            </div>
            <div className="sixwide many">
        ...
        <div className="sixwide many">
          <p>
            ...
            will be randomly scattered around a certain radius depending on the
            scatter. If Both Axis is disabled it will only scatter in the right
            angle from your line. If you choose a control for scatter you must
            set it higher then 0%, otherwise it won&#8217;t do anything.
          </p>
          <p>
            If you increase the Count there will be more Brush marks scattered
            around every spacing interval of the stroke. This value makes only
            sense used in combination with scatter. It works different than
            spacing. Because spacing determines how much space is left between
            every interval. The count determines how often your brush marks is
            drawn on each of these intervals. Without scatter all these brush
        ...
        <div className="sixwide many">
          ...
          <ul>
            <li>
              <p>
                <strong>The small graphic</strong> at the top is the texture
                that will be used.
              </p>
            </li>
            <li>
              <p>
                <strong>Scale</strong> determines how big the texture will be.
                This is independent from your brush size. The scale of the
                texture will always be the same, no matter how big your brush
                is. This allows you do create some kind of canvas effect with
                texture.
              </p>
            </li>
            <li>
              <p>
                <strong>Mode</strong> defines in which way the texture will be
                laid over your brush. It is hard to explain the different modes,
                so its best to try them out. I like Hard Mix.
              </p>
            </li>
            <li>
              <p>
                <strong>Depth</strong> lets you adjust how strong the texture
                will affect your brush. A maximum depth can lead to spots of no
                opacity in your brush while no depth won&#8217;t affect your
                brush at all.
              </p>
            </li>
          </ul>
        ...
        <div className="sixwide many">
          ...
          <p>
            In this menu you can choose a second Brush and define certain
            properties for this brush (they work the same way as for a normal
            brush).
          </p>
          <p>
            This Brush then will be overlayed in one of the same modes as you
            could choose for texture over your original brush.
          </p>
          <p>
            ...
            also scattering one or both of the Brushes influences the outcome.
            You should just play around with the options and try different
            combinations.
          </p>
        </div>
        <div className="sixwide many center">
        ...
        <ul className="fullwidth">
          <li>
            <div className="sixwide many">
              <p>
                ...
                used with pen pressure this works pretty much like opacity, just
                that you have different colors depending on your pressure,
                instead of a lower or higher opacity. If you use a random jitter
                this will give your brush strokes some nice effects, depending
          ...
          <li>
            <p>
              <strong>Purity</strong> is only of use if you combine it with the
              hue jitter. The higher the purity the more saturated the average
              color will be. 100% purity means the color is completely
              saturated. This works a little bit like a minimum slider. Without
              a hue jitter this just changes the saturation of your
              foreground-color.
            </p>
          </li>
        </ul>
          ...
          <li>
            <div className="sixwide many">
              <p>
                ...
                Used with Pen Pressure, this gives you the classic, pressure
                sensitive Brush. If you use the blur or sharpen tool instead of
                a normal brush tool, opacity becomes Strength which will
                determine how strong these tools work. For the dodge and burn
          ...
          <li>
            <div className="sixwide many">
              <p>
                ...
                stroke, meaning no point of a brush stroke can be more opaque
                than the value you set it, flow just defines the covering power
                of each brush mark. This means even with 10% Flow you can get
                achieve opacity of 100% by just painting over the same position
                for some time.
              </p>
            </div>
            <div className="sixwide many center">
        ...
        <ul className="fullwidth">
          ...
          <li>
            <div className="sixwide many">
              <p>
                ...
                adjust this effect it is a little bit impractical but can create
                nice effects.
              </p>
            </div>
            <div className="sixwide many center">
          ...
          <li>
            <div className="sixwide many">
              <p>
                ...
                hold it in one place. This works independently form flow but can
                be combined with it.
              </p>
            </div>
            <div className="sixwide many center">
          ...
          <li>
            <p>
              <strong>Protect Texture</strong> is only useful if you use the
              tool presets. It keeps the same texture for all presets, that are
