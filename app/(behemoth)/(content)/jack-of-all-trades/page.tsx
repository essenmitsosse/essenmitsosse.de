...
<html lang="en">
  <head>
    ...
    <title>Jack of all Trades &clubs; essenmitsosse</title>

    <meta name="robots" content="index, follow" />
    <meta
      name="description"
      content="A movie about creativity and getting things done."
    />
    <meta name="keywords" content="" />
    <meta name="date" content="2012-04-17" />
    <meta name="author" content="Marcus Bl&auml;ttermann" />

    <link rel="prev" title="The Human Brain" href="the-human-brain" />
    ...
    <div class="content white">
      ...
      <div class="sixwide">
        <p>
          ...
          see how creativity works, how you can force yourself to get things
          done, how to make decisions, avoid distraction and boost
          ...
          want to sit there and tell people how we think things work. Instead we
          decided to share our insights in form of a small parable. No absolute
          statements. Everybody should decide for themselves, what can be drawn
          from the film.
        </p>
      </div>
      <hr />
