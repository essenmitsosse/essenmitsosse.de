  ...
  return (
    <body className="single article">
      ...
      <div className="content white">
        ...
        <p>
          Another disadvantage of the new surface is that it drastically
          increases the wearing of the tips. This is especially noticeable
          compared to the Intuos3, where it took the tips an eternity before
          they became unusable (I used some for over a year) and now first signs
          of use can already be seen after several days.
        </p>
        <p>
          So for me these are two downsides of the new surface, but I think a
          lot of people can live with the increased consumption of tips, because
          they will enjoy the new surface.
        </p>
        <h3>
        ...
        <p>
          The new pen holder can now be opened and is also a storage for up to
          ten additional nibs.
        </p>
        <h3>More Accuracy</h3>
        <p>
          The accuracy of the Intuos4 has been increased. The Pen now has twice
          as many pressure levels (2048 instead of 1024) and the minimum
          pressure that can be recognized has been reduced from 10 to 1 gram.
          This is pretty nice, but barley noticeable, since the Intuos3 was
          already pretty accurate (especially compared to lower-price graphics
        ...
        <div className="sixwide">
          ...
          <ul>
            ...
            <li>
              <p>
                The USB-cable is removable (with a standard mini-USB plug),
                making it easier to put the tablet aside.
              </p>
            </li>
            <li>
              <p>
                The Radial menu offers a lot of possibiltys to improve and
        ...
        <div className="sixwide">
          ...
          <ul>
            ...
            <li>
              <p>
                Only one TouchingRing, in contrast to the two touch strips of
                the bigger Intuos3 tablets. Switching through the four different
