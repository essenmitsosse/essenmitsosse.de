    ...
    <div id="introduction" className="homepresentation">
      <div className="wrapper">
        ...
        <p>
          ...
          . I work as a freelancer for illustration, print- & webdesign. If you
          like my work you can <script type="text/javascript">mail2();</script>
          <noscript>hire me</noscript>.
        </p>
        <p>
          You should get my{" "}
          <a href="http://feeds.feedburner.com/essenmitsosse">RSS-Feed</a> and
          follow me on <a href="http://twitter.com/essenmitsosse">Twitter</a>.
        </p>
        ...
        <table>
          ...
          <tr>
            <th>Facebook</th>
            <td>
              <a href="http://www.facebook.com/essenmitsosse">/essenmitsosse</a>
            </td>
          </tr>
        </table>
      </div>
