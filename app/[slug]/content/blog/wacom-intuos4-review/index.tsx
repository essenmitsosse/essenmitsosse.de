...
export default function Page() {
  return (
    <>
      ...
      <p>
        The changes in the design of the new Intuos4 aren&rsquo;t just optical.
        In contrast to its predecessor all buttons are now only on one side. The
      ...
      <p>
        ...
        you have to switch through these functions by pressing the button in the
      ...
      <p>
        ...
        was already a great graphics tablet and it&rsquo;s still today. So
        it&rsquo;s up to you to decide if you really need the improvements of
        the Intuos4 or if the Intuos3 (or maybe even a{' '}
        <a href="http://www.amazon.com/gp/product/B000V9T2JA?ie=UTF8&amp;tag=essencompucan-20&amp;linkCode=as2&amp;camp=1789&amp;creative=9325&amp;creativeASIN=B000V9T2JA">
          Bamboo
        </a>
        ) my suffice for you.
