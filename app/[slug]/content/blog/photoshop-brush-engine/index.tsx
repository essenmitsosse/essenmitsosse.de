...
import imageBrushTipShape from './brush-tip-shape.gif'
import imageSize from './size.gif'
import imageAngle from './angle.gif'
import imageRoundness from './roundness.gif'
import imageScattering from './scattering.gif'
import imageTexture from './texture.gif'
import imageDualBrush from './dual-brush.gif'
