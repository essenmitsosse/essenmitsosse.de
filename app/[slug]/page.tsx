...
<?php if (in_category('portfolio')) {?><body class="single black portfolio"><?php } else {?>
<body class="single article"><?php } ?>

	<ul id="navigation" class="black">
		<li class="home"><a href="http://essenmitsosse.de" rel="index">Home</a></li>
	...
	<div class="intro<?php if (in_category('articles')) {?> color<?php } ?>" style="background-image:url(<?php echo $headerimage[0]; ?>);">
		<p class="logo"><a href="http://essenmitsosse.de/" id="essenmitsosse"><span class="club">&clubs;</span>essenmitsosse <em>presents</em></a></p>
		<h1><?php the_title(); ?></h1>
	</div>
...
<hr/>		
		<div class="fourwide">
			...
			<p>My name ist Marcus Blättermann. <br/>I’m majoring in communication design and work as a freelancer for illustration, print- & webdesign. If you like my work you can <script type="text/javascript">mail2();</script><noscript>hire me. marcus -at- essenmitsosse -dot- de</noscript>.</p>
		</div>

		<div class="fourwide">
			<h3><em>What you should </em>do next</h3>
			<p>Don’t forget to subscribe to my <a href="http://feeds.feedburner.com/essenmitsosse" rel="alternate">RSS-Feed</a> and follow me on <a href="http://twitter.com/essenmitsosse">Twitter</a>. You should also check out my <a href="http://essenmitsosse.de">Portfolio</a>.</p>
		</div>

		<div class="fourwide">
			<h3><em>If you didn&#8217;t like this one</em>You will hate these</h3>
